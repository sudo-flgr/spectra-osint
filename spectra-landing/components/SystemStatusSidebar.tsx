...
const logs = [
    ...
    "[DEFESA] ESCUDO ATIVO: PROTEÇÃO TRANS",
...
export function SystemStatusSidebar() {
    ...
    return (
        <aside className="fixed left-0 top-0 bottom-0 w-[20%] min-w-[250px] bg-black/90 border-r-2 border-spectra-cyan z-40 hidden lg:flex flex-col font-mono text-xs text-spectra-cyan p-4 overflow-hidden">
