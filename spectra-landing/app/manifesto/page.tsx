    ...
    return (
        <main className="min-h-screen bg-spectra-bg text-white selection:bg-spectra-cyan/30 flex flex-col font-mono relative">
            ...
            <div className="flex-1 w-full max-w-5xl mx-auto px-6 py-32">
                ...
                {/* Header */}
                <header className="mb-20 text-center lg:text-left border-b border-white/10 pb-10">
                ...
                <section className="mb-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-300 leading-relaxed text-lg text-justify border-l-4 border-gray-700 pl-6">
                            ...
                            <br /><br />
                            Entendemos que a privacidade é um direito humano fundamental, especialmente para corpos dissidentes que são alvos constantes de vigilância e violência. Nossaos serviços são construídos para garantir autonomia e segurança.
                        </p>
                    </div>
                ...
                <section className="border-t border-spectra-pink/30 pt-20">
